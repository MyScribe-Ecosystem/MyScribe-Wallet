...
export enum RouteTypes {
    ...
    OrdinalsTabScreen = 'OrdinalsTabScreen',
    InscriptionDetailScreen = 'InscriptionDetailScreen',
    SendInscriptionScreen = 'SendInscriptionScreen',
...
export const routePaths: Record<RouteTypes, string> = {
    ...
    [RouteTypes.OrdinalsTabScreen]: '/ordinals',
    [RouteTypes.InscriptionDetailScreen]: '/ordinals/detail',
    [RouteTypes.SendInscriptionScreen]: '/ordinals/send',
