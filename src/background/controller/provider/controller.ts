...
export class ProviderController {
    ...
    getBalance = async () => {
        ...
        return {
            ...
            csv3_total: amountToSatoshis(balance.csv3_total_amount || '0'),
            csv3_unlocked: amountToSatoshis(balance.csv3_unlocked_amount || '0'),
            csv3_locked: amountToSatoshis(balance.csv3_locked_amount || '0'),
